              ...
              <div className="flex-1">
                ...
                <div className="pt-5 border-t border-border/40">
                  <p className="text-sm text-foreground font-semibold mb-4">
                    Mas se isso é para você — se você vende por conversas e quer entender o que está travando sua conversão:
                  </p>
                  <a
                    href="#oferta"
                  ...
                  >
                    Se isso é para você, veja a oferta <ArrowRight className="w-4 h-4" />
                  </a>
                </div>
              </div>
