...
import { ArrowRight, CheckCircle2, Lock, ShieldCheck, Zap, MessageCircle, BrainCircuit } from 'lucide-react';
...
export function Oferta() {
  return (
    <section id="checkout" className="py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <FadeIn>
          <div className="relative bg-card border-2 border-primary/25 rounded-3xl p-8 md:p-12 shadow-[0_0_80px_rgba(0,0,0,0.4)] overflow-hidden">
            ...
            <div className="flex justify-center mb-8">
              <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-5 py-2 text-sm font-bold text-primary tracking-wide">
                ...
                MVP v1 — Acesso Especial
              </div>
            </div>

            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                Entre na primeira versão do{' '}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">
                  RAIO-X OS
                </span>
              </h2>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed max-w-xl mx-auto">
                Acesse o MVP v1 do sistema de auditoria comercial baseada em evidências e comece a revisar suas negociações com mais clareza.
              </p>
            </div>
            ...
            <p className="text-center text-sm text-muted-foreground mb-6 font-medium">
              Acesso imediato · Garantia de 7 dias · Sem mensalidade
            </p>

            <div className="flex flex-wrap justify-center gap-5 text-sm font-medium text-muted-foreground pt-5 border-t border-border/40">
              <div className="flex items-center gap-1.5">
                <Lock className="w-4 h-4 text-primary" /> Compra Segura
              </div>
              <div className="flex items-center gap-1.5">
                <ShieldCheck className="w-4 h-4 text-primary" /> Garantia de 7 dias
              </div>
              <div className="flex items-center gap-1.5">
